...
export const metadata: Metadata = {
  ...
  description:
    "MD Athar Alam (Build With Athar) — Senior Full-Stack Engineer at Hashcash. 5 years architecting 10 production SaaS platforms solo: Model Context Protocol (MCP) servers, RAG pipelines, WebRTC, no-code builders, captcha infrastructure, multi-tenant DNS automation. Next.js · Node.js · MongoDB · AWS.",
  ...
  openGraph: {
    ...
    description:
      "5 years · 10 production SaaS platforms shipped solo. MCP servers · RAG · WebRTC · no-code builders · captcha infra · multi-tenant DNS. Next.js · Node.js · MongoDB · AWS.",
    locale: "en_US",
    images: [
      {
        url: OG_IMAGE,
  ...
  twitter: {
    ...
    title: "Build With Athar — Senior Full-Stack Engineer · Platform Architect",
    description:
      "5 years · 10 production SaaS platforms shipped solo. MCP servers · RAG · WebRTC · no-code builders · captcha infra. Next.js · Node.js · MongoDB · AWS.",
    images: [OG_IMAGE],
  ...
  return (
    <html lang="en">
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@300;400;500;600;700&family=JetBrains+Mono:wght@400;500;600&family=Instrument+Serif:ital@0;1&family=Kalam:wght@400;700&family=Caveat:wght@500;700&display=swap"
          rel="stylesheet"
        />
        <script
